...
python train.py -m HHH_RNN -s --action eating walking -e 1024 -r -d 1 -O Nadam;
python train.py -m HHH_RNN -s -e 1024 -r -d 1 -O Nadam;
python train.py -m HHH_RNN -s --action eating walking -e 1024 -r -d 1 -O Nadam --add_noise 0.01;
